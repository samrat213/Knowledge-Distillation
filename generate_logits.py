...
class TeacherModel:
    def __init__(self, model_path=teacher_path, gpu=0):
...
for i in tqdm(range(0, len(prompts), batch_size), desc="Generating logits"):
    ...
    # yen
    # thread1 = threading.Thread(target=obj.add_data, args=(batch_prompts,batch_logits,))
    # thread1.start()
